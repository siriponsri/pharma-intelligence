"""Build the NLEM scaffold dataset from an optional local export."""
...
from pharma_intel.ingestion.nlem_scraper import run
...
def main(
    ...
    """Write the NLEM parquet artifact."""
    written_path = run(output_path=output, input_path=input_path)
    console.print(f"[green]Saved NLEM dataset to {written_path}[/green]")
